...
df = pd.read_csv('Fiscal/GFDEBTN/GFDEBTN.csv')
...
# Plot line
ax1.plot(df['observation_date'], df['GFDEBTN'],
         linewidth=2, color='#DF543B')

# Shaded area under the line
ax1.fill_between(df['observation_date'], df['GFDEBTN'],
...
ax1.set_ylim(0, df['GFDEBTN'].max() * 1.05)
...
# Title - normal weight
plt.title("Total Public Debt", fontsize=14, fontweight='normal')
